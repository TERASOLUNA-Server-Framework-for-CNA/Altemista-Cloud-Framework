...
.org/altemista/cloudfwk/config/core/altemista-cloudfwk-core-batch-spring.xml
----
include::{basedir}/altemista-cloudfwk-core-batch-spring-conf/src/main/resources/org/altemista/cloudfwk/config/core/altemista-cloudfwk-core-batch-spring.xml[tags=internals1]
----
...
.org/altemista/cloudfwk/config/core/altemista-cloudfwk-core-batch-spring.xml
----
include::{basedir}/altemista-cloudfwk-core-batch-spring-conf/src/main/resources/org/altemista/cloudfwk/config/core/altemista-cloudfwk-core-batch-spring.xml[tags=internals2]
----
<1> As described in the <<altemista-cloudfwk-core-batch-spring-conf-configuration,configuration>> paragraphs of this module, a data source to store the jobs meta-data and execution information is required.
