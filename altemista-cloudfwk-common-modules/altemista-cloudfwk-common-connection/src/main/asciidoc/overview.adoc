...
[source]
----
include::{basedir}/altemista-cloudfwk-common-connection/src/test/java/org/altemista/cloudfwk/test/proxy/ProxyTest.java[tags=usage]
----
...
NOTE: This feature uses utility classes from the <<altemista-cloudfwk-common-security-overview,security utilities>> feature. 
