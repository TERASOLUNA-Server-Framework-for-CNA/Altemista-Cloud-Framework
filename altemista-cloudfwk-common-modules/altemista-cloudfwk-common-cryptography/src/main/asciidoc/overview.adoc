...
CAUTION: To use either _symmetric encryption and decryption using AES_ or _asymmetric encryption and decryption using RSA_ you need the full-strengh JCE installed in your JVM (it is not included by default). Please read the <<altemista-cloudfwk-common-cryptography-java>> section.
...
[source]
----
include::{basedir}/altemista-cloudfwk-common-cryptography/src/test/java/org/altemista/cloudfwk/test/cryptography/util/AESExampleTest.java[tags=text]
----
...
[source]
----
include::{basedir}/altemista-cloudfwk-common-cryptography/src/test/java/org/altemista/cloudfwk/test/cryptography/util/AESExampleTest.java[tags=binary]
----
...
[source]
----
include::{basedir}/altemista-cloudfwk-common-cryptography/src/test/java/org/altemista/cloudfwk/test/cryptography/util/RSAExampleTest.java[tags=text]
----
...
[source]
----
include::{basedir}/altemista-cloudfwk-common-cryptography/src/test/java/org/altemista/cloudfwk/test/cryptography/util/RSAExampleTest.java[tags=binary]
----
