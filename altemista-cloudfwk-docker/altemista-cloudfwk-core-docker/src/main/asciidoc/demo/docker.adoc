...
include::{basedir}/altemista-cloudfwk-core-docker/demo/config_server.adoc[]

===== Registry Server

include::{basedir}/altemista-cloudfwk-core-docker/demo/registry.adoc[]

===== Gateway Server

include::{basedir}/altemista-cloudfwk-core-docker/demo/gateway.adoc[]

===== Microservice

include::{basedir}/altemista-cloudfwk-core-docker/demo/microservice.adoc[]
...
image::altemista-cloudfwk-documentation/docker/docker_eureka.png[align="center"]
