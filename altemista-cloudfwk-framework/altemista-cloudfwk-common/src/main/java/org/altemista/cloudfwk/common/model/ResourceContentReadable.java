...
public class ResourceContentReadable implements ContentReadable, InputStreamSource, Serializable {
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.common.model.ContentReadable#getContentType()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.common.model.ContentReadable#getPath()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.common.model.StreamContentReadable#toString()
	 */
	@Override
