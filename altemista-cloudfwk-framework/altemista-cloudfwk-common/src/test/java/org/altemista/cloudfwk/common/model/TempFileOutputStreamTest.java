...
/**
 * Tests the OutputStream backed up by a temporary file.
 * @author NTT DATA
 */
public class TempFileOutputStreamTest extends AbstractOutputStreamTest<TempFileOutputStream> {
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.common.model.AbstractOutputStreamTest#createOutputStream()
	 */
	@Override
	protected TempFileOutputStream createOutputStream() throws IOException {
