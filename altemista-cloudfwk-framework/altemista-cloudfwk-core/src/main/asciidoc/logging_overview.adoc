...
[source]
----
include::{basedir}/altemista-cloudfwk-core/src/test/java/org/altemista/cloudfwk/core/logging/LoggerExample.java[tags=definition]
----
...
[source]
----
include::{basedir}/altemista-cloudfwk-core/src/test/java/org/altemista/cloudfwk/core/logging/LoggerExample.java[tags=basic]
----
...
[source]
----
include::{basedir}/altemista-cloudfwk-core/src/test/java/org/altemista/cloudfwk/core/logging/LoggerExample.java[tags=advanced]
----
