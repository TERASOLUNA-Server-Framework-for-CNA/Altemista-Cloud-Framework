package org.altemista.cloudfwk.core.properties.impl;
...
import org.altemista.cloudfwk.core.properties.PropertiesProvider;

/**
 * Simple database-backed properties provider. Usage:<br>
 * <tt>&lt;bean id="databasePropertiesProvider" class="org.altemista.cloudfwk.core.properties.bean.DatabasePropertiesProvider"&gt;<br>
...
public class DatabasePropertiesProvider extends JdbcDaoSupport implements PropertiesProvider {
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.core.properties.PropertiesProvider#getProperty(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.core.properties.PropertiesProvider#getProperty(java.lang.String, java.lang.String)
	 */
	@Override
