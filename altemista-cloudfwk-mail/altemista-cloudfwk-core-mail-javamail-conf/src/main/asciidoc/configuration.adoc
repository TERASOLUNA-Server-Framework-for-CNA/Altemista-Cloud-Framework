...
----
include::{basedir}/altemista-cloudfwk-core-mail-javamail-conf/src/test/resources/config/properties/test-mail-env.example[]
----

TIP: If changing this configuration values is not enough, refer to the <<altemista-cloudfwk-core-mail-javamail-conf-internals,internals>> of this module.
