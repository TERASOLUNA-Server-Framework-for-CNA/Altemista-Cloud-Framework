...
image::altemista-cloudfwk-documentation/microservices/demo/overview.png[align="center"]
...
include::{basedir}/altemista-cloudfwk-core-microservices/demo/infrastructure.adoc[]

== Backend

include::{basedir}/altemista-cloudfwk-core-microservices/demo/backend.adoc[]

== Query Health: Communication between microservices example

include::{basedir}/altemista-cloudfwk-core-microservices/demo/queryhealth.adoc[]

== Frontend: User Interface

include::{basedir}/altemista-cloudfwk-core-microservices/demo/frontend.adoc[]

[[demo-resources]]
== Demo resources

include::{basedir}/altemista-cloudfwk-core-microservices/demo/resources.adoc[]