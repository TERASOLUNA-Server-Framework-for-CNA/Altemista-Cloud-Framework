...
[[altemista-cloudfwk-app-performance-conf-internals-core]]
== Core performance

The core performance module declares the support beans for the performance feature as follows:

[source,xml,options="nowrap"]
.org/altemista/cloudfwk/config/core/altemista-cloudfwk-core-performance.xml
----
include::{basedir}/altemista-cloudfwk-app-performance-conf/src/main/resources/org/altemista/cloudfwk/config/core/altemista-cloudfwk-core-performance.xml[tags=internals]
----
...
[source,xml,options="nowrap"]
.org/altemista/cloudfwk/config/performance/altemista-cloudfwk-performance-jdbc.xml
----
include::{basedir}/altemista-cloudfwk-app-performance-jdbc-conf/src/main/resources/org/altemista/cloudfwk/config/performance/altemista-cloudfwk-performance-jdbc.xml[tags=internals]
----
...
[[altemista-cloudfwk-app-performance-conf-internals-web]]
== Web performance
...
[source,xml,options="nowrap"]
.altemista-cloudfwk-app-performance-web-conf/src/main/resources/META-INF/web-fragment.xml
----
include::{basedir}/altemista-cloudfwk-app-performance-web-conf/src/main/resources/META-INF/web-fragment.xml[tags=internals]
----

This configuration effectively relies on Spring beans:

[source,xml,options="nowrap"]
.org/altemista/cloudfwk/config/web/altemista-cloudfwk-web-performance.xml
----
include::{basedir}/altemista-cloudfwk-app-performance-web-conf/src/main/resources/org/altemista/cloudfwk/config/web/altemista-cloudfwk-web-performance.xml[tags=internals]
----
