...
----
include::{basedir}/altemista-cloudfwk-core-persistence-mongodb-conf/src/test/java/com/mycompany/application/module/model/RecipeExample.java[tags=example]
}
----
...
----
include::{basedir}/altemista-cloudfwk-core-persistence-mongodb-conf/src/test/java/com/mycompany/application/module/repository/RecipeRepositoryExample.java[tags=example]
----
...
----
include::{basedir}/altemista-cloudfwk-core-persistence-mongodb-conf/src/test/java/com/mycompany/application/module/service/RecipeServiceExampleImpl.java[tags=example]
----
...
[[altemista-cloudfwk-core-persistence-mongodb-conf-dynamic-quering]]
== Dynamic querying
...
.com/mycompany/application/module/service/RecipeServiceExampleImpl.java
----
include::{basedir}/altemista-cloudfwk-core-persistence-mongodb-conf/src/test/java/com/mycompany/application/module/service/RecipeServiceExampleImpl.java[tags=queryDSL]
----
...
IMPORTANT: The <<altemista-cloudfwk-core-persistence-mongodb-conf-configuration-dynamic,Querydsl generator Maven plug-in>> must be configured to use this feature.
...
IMPORTANT: The {framework} application must provide Spring Data REST support to use this feature. See the <<altemista-cloudfwk-core-persistence-mongodb-conf-maven,maven considerations>> section.
