...
The <<altemista-cloudfwk-core-persistence-mybatis-conf-internals,infrastructure definded by the framework>> reads some convenient values from the configuration of the application:

[source,properties]
.config/properties/altemista-cloudfwk-test-persistence-mybatis-env.properties
----
include::{basedir}/altemista-cloudfwk-core-persistence-mybatis-conf/src/test/resources/config/properties/altemista-cloudfwk-test-persistence-mybatis-env.properties[]
----
...
----
include::{basedir}/altemista-cloudfwk-core-persistence-mybatis-conf/src/test/resources/spring/altemista-cloudfwk-example-mybatis.xml[tags=datasource]
----
...
----
include::{basedir}/altemista-cloudfwk-core-persistence-mybatis-conf/src/test/resources/spring/altemista-cloudfwk-example-mybatis.xml[tags=repositories]
----
...
./altemista-cloudfwk-core-persistence-mybatis-conf/src/test/resources/config/mybatis/mybatis-config.xml
----
include::{basedir}/altemista-cloudfwk-core-persistence-mybatis-conf/src/test/resources/config/mybatis/mybatis-config.xml[]
----
...
[[altemista-cloudfwk-core-persistence-mybatis-conf-configuration-generator]]
...
.generatorConfig.xml
----
include::{basedir}/altemista-cloudfwk-core-persistence-mybatis-conf/src/test/resources/generatorConfig.xml[]
----
...
The <<altemista-cloudfwk-core-persistence-mybatis-conf-internals,MyBatis infrastructure provided by the {framework}>> does only support one single database (i.e.: one single _datasource_). However, it is possible to use multiple databases in {framework} applications by declaring an alternative infrastructure. Namely:
