...
<bean id="rulesetContainerResolver"
		class="org.altemista.cloudfwk.core.rules.ruleset.impl.NameBasedRulesetContainerResolverImpl">
	<constructor-arg>
		<map>
...
----
include::{basedir}/altemista-cloudfwk-core-rules-drools-conf/src/test/resources/META-INF/kmodule.xml[]
----
...
See the <<altemista-cloudfwk-core-rules-drools-conf-configuration-repository>> section for further information.

[[altemista-cloudfwk-core-rules-drools-conf-configuration-repository]]
...
[source,xml]
----
include::{basedir}/altemista-cloudfwk-core-rules-drools-conf/src/test/resources/spring/test-app-context-rules-repository.xml[tags=default]
----
...
CAUTION: To use this feature, <<altemista-cloudfwk-core-rules-drools-conf-maven-kie-ci>>.
