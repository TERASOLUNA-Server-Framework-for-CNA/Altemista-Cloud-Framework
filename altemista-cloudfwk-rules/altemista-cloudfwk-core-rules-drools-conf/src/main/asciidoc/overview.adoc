...
[source,java]
----
include::{basedir}/altemista-cloudfwk-core-rules-drools-conf/src/test/java/org/altemista/cloudfwk/test/rules/DefaultTest.java[tags=autowire]
----
...
[source,java]
----
include::{basedir}/altemista-cloudfwk-core-rules-drools-conf/src/test/java/org/altemista/cloudfwk/test/rules/DefaultTest.java[tags=example]
----
...
Rule sets are referred to using logical names. Please refer to the specific <<altemista-cloudfwk-core-rules-drools-conf-configuration,implementation provider configuration>> section to know how logical names are mapped to actual rule sets.
...
[source,java]
----
include::{basedir}/altemista-cloudfwk-core-rules-drools-conf/src/test/java/org/altemista/cloudfwk/test/rules/StatefulTest.java[tags=example]
----
