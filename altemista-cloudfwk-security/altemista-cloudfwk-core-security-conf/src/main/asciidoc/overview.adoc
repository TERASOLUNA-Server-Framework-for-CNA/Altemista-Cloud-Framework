...
[source]
----
include::{basedir}/altemista-cloudfwk-core-security-conf/src/test/java/org/altemista/cloudfwk/test/security/service/SecuredService.java[tags=class;secured]
----
...
[source]
----
include::{basedir}/altemista-cloudfwk-core-security-conf/src/test/java/org/altemista/cloudfwk/test/security/service/SecuredService.java[tags=class;jsr250]
----
<1> All security roles are allowed to invoke this method.
<2> Only the users with the role `ROLE_ADMIN` are allowed invoke this method.
<3> No security roles are allowed to invoke this method.

NOTE: Additional configuration is required ir oder to use JSR 250: Common Annotations. Please refer to the <<altemista-cloudfwk-core-security-conf-maven>> section.
...
.SecuredService.java
----
include::{basedir}/altemista-cloudfwk-core-security-conf/src/test/java/org/altemista/cloudfwk/test/security/service/SecuredService.java[tags=class;expression]
----
