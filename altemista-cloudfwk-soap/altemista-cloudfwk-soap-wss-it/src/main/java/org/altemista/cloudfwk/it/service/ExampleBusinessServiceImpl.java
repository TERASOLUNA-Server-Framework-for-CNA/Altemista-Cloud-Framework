...
public class ExampleBusinessServiceImpl implements ExampleBusinessService {
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.it.service.ExampleBusinessService#hello(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.it.service.ExampleBusinessService#helloAuthenticatedUser()
	 */
	@Override
	public String helloAuthenticatedUser() {
		...
		if (!(authentication.getPrincipal() instanceof UserDetails)) {
			throw new IllegalStateException("The principal is not an instance of UserDatils: " + authentication.getPrincipal());
		}
	...
	/* (non-Javadoc)
	 * @see org.altemista.cloudfwk.it.service.ExampleBusinessService#helloAuthorizedUser()
	 */
	@Override
