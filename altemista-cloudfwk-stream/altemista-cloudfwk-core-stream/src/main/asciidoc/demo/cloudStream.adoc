...
include::{basedir}/altemista-cloudfwk-core-stream/demo/cloudStreamKafka.adoc[]


=== Spring Cloud Stream demo with RabbitMQ

include::{basedir}/altemista-cloudfwk-core-stream/demo/cloudStreamRabbitMQ.adoc[]


=== Spring Cloud Stream Consumer Groups demo

include::{basedir}/altemista-cloudfwk-core-stream/demo/cloudStreamGroups.adoc[]


=== Spring Cloud Stream DLQ demo

include::{basedir}/altemista-cloudfwk-core-stream/demo/cloudStreamHandling.adoc[]