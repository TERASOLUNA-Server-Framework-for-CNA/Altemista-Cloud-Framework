 ...
 */
@RestController
@RequestMapping(value = WebI18nController.MAPPING, method = RequestMethod.GET)
public class WebI18nController {

	/** MAPPING String */
	public static final String MAPPING = "/webi18n";
	...
	public Object checkMessageSource() {
		...
		String message = messageResource.getMessage("e.org.altemista.cloudfwk.core.exception.dummy", null);
