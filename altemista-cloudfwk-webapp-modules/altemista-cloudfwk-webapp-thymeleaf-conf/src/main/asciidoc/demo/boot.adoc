...
In this example we will create a ACF Thymeleaf boot application.

We will add initial business module stand-alone-implementation.

Over the boot project add a new "ALTEMISTA Cloud Framework (ACF) Feature" and choose the "Thymeleaf".
...
//
[source,properties]
./src/main/resources/config/properties/new-application-thymeleaf.properties
----
...
Run your application using any web server you want and the application should have been deployed in "http://localhost:8080/"
