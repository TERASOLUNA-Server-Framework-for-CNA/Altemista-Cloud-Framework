...
include::{basedir}/cloud-altemistafwk-core-amazon/demo/rds_demo.adoc[]

== S3

include::{basedir}/cloud-altemistafwk-core-amazon/demo/s3_demo.adoc[]

== SES

include::{basedir}/cloud-altemistafwk-core-amazon/demo/ses_demo.adoc[]

== SQS

include::{basedir}/cloud-altemistafwk-core-amazon/demo/sqs_demo.adoc[]


[[demo-resources]]
== Demo resources

include::{basedir}/cloud-altemistafwk-core-amazon/demo/resources.adoc[]