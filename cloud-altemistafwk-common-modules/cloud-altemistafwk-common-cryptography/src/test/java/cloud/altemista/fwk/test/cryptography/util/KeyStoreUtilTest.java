...
/*
 * #%L
 * cloud-altemistafwk common: cryptography utilities
 * %%
...
import cloud.altemista.fwk.common.cryptography.exception.CryptographyException;
...
public class KeyStoreUtilTest {
	...
	public void testGetKeyStoreSanityChecks() {
		...
		try {
			...
			Assert.assertEquals("e.cloud.altemista.fwk.common.cryptography.exception.no_keystore", e.getCode());
		}
		...
		try {
			...
			Assert.assertEquals("e.cloud.altemista.fwk.common.cryptography.exception.no_keystore_resource", e.getCode());
		}
		...
		try {
			...
			Assert.assertEquals("e.cloud.altemista.fwk.common.cryptography.exception.no_keystore_password", e.getCode());
		}
		...
		try {
			...
			Assert.assertEquals("e.cloud.altemista.fwk.common.cryptography.exception.no_keystore_type", e.getCode());
		}
		bean.setType("");
		try {
			KeyStoreUtil.getKeyStore(bean);
		...
		try {
			...
			Assert.assertEquals("e.cloud.altemista.fwk.common.exception.resource_not_found", e.getCode());
		}
	}
	...
	public void testGetPublicKey2() throws KeyStoreException {
		...
		try {
			...
			Assert.assertEquals("e.cloud.altemista.fwk.common.cryptography.exception.publickey_notfound", e.getCode());
		}
	...
	public void testGetPrivateKey1() throws KeyStoreException {
		...
		try {
			...
			Assert.assertEquals("e.cloud.altemista.fwk.common.cryptography.exception.privatekey_notfound", e.getCode());
		}
	}
