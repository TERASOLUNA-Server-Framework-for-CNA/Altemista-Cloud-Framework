...
package cloud.altemista.fwk.core.async.impl;
...
import cloud.altemista.fwk.core.async.model.FutureWrapper;
...
public class MemoryStoragePolicy<T> implements AsyncStoragePolicy<T>, InitializingBean {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.async.AsyncStoragePolicy#put(java.util.concurrent.Future)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.async.AsyncStoragePolicy#put(java.lang.String, java.util.concurrent.Future)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.async.AsyncStoragePolicy#containsId(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.async.AsyncStoragePolicy#get(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.async.AsyncStoragePolicy#remove(java.lang.String)
	 */
	@Override
