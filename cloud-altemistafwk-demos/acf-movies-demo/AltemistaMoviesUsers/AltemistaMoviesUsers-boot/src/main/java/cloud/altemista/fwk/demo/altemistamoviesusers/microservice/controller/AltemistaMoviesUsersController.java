...
public class AltemistaMoviesUsersController implements AltemistaMoviesUsers {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.demo.altemistamoviesusers.microservice.service.AltemistaMoviesUsers#listAllUsers()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.demo.altemistamoviesusers.microservice.service.AltemistaMoviesUsers#getUser(long)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.demo.altemistamoviesusers.microservice.service.AltemistaMoviesUsers#createUser(cloud.altemista.fwk.demo.altemistamoviesusers.microservice.domain.UserDTO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.demo.altemistamoviesusers.microservice.service.AltemistaMoviesUsers#updateUser(long, cloud.altemista.fwk.demo.altemistamoviesusers.microservice.domain.UserDTO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.demo.altemistamoviesusers.microservice.service.AltemistaMoviesUsers#deleteUser(long)
	 */
	@Override
