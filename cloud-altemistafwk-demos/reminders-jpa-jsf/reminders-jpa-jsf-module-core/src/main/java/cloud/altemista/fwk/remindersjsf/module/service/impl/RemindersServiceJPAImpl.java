...
import cloud.altemista.fwk.remindersjsf.module.entity.RmndrsTable;
...
import cloud.altemista.fwk.remindersjsf.module.repository.RmndrsRepository;
...
public class RemindersServiceJPAImpl extends AbstractRemindersServiceImpl implements RemindersService {
	...
	public TaskDTO getDetail(long id) {
		TaskDTO detail = mapper(repository.findById(id).get());
		return detail;
	}
	 ...
	 * 
	 * @see
	 * cloud.altemista.fwk.reminders.service.impl.AbstractRemindersServiceImpl#addTask(
	 * cloud.altemista.fwk.reminders.TaskDTO)
	 */
	 ...
	 * 
	 * @see
	 * cloud.altemista.fwk.reminders.service.impl.AbstractRemindersServiceImpl#editTask(
	 * cloud.altemista.fwk.reminders.TaskDTO)
	 */
	...
	public void complete(long id) {
		RmndrsTable data = repository.findById(id).get();
