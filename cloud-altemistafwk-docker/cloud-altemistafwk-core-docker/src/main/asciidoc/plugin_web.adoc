...
image::cloud-altemistafwk-documentation/docker/docker_web.png[align="center"]

In the next screenshot, you can type the image name that you will use to build and run it.

image::cloud-altemistafwk-documentation/docker/docker_web_image.png[align="center"]
