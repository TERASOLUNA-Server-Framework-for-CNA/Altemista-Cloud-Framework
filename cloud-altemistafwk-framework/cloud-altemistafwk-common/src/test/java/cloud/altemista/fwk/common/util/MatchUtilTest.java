...
public class MatchUtilTest {
	...
	public void testStackTraceElementMatching() {
		...
		Assert.assertNotNull(MatchUtil.stackTraceElementMatching("cloud.altemista.fwk.common.util.MatchUtilTest"));
		Assert.assertNotNull(MatchUtil.stackTraceElementMatching("cloud.altemista.fwk.common.util.*Test"));
		Assert.assertNotNull(MatchUtil.stackTraceElementMatching("cloud.altemista.fwk.**.*Test"));
