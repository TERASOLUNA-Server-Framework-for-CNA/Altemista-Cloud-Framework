...
^.^|image:cloud-altemistafwk-documentation/frameworks/spring.png[align="center"] |Spring IO Platform    |Cairo-SR3
^.^|image:cloud-altemistafwk-documentation/frameworks/spring.png[align="center"] |Spring Framework    |5.0.8.RELEASE
^.^|image:cloud-altemistafwk-documentation/frameworks/spring.png[align="center"] |Spring Boot    |2.0.4.RELEASE
^.^|image:cloud-altemistafwk-documentation/frameworks/apache-commons.jpg[align="center"] |Apache Commons Collections |4.1
^.^|image:cloud-altemistafwk-documentation/frameworks/apache-commons.jpg[align="center"] |Apache Commons FileUpload |1.3.2
^.^|image:cloud-altemistafwk-documentation/frameworks/apache-commons.jpg[align="center"] |Apache Commons IO |2.5
^.^|image:cloud-altemistafwk-documentation/frameworks/apache-commons.jpg[align="center"] |Apache Commons Lang |3.4
^.^|image:cloud-altemistafwk-documentation/frameworks/aspectj.jpg[align="center"] |AspectJ |1.8.13
^.^|image:cloud-altemistafwk-documentation/frameworks/json.png[align="center"] |Jackson JSON processor |2.8.5

.2+^.^|Logging
^.^|image:cloud-altemistafwk-documentation/frameworks/slf4j.jpg[align="center"] |Simple Logging Facade for Java (SLF4J) |1.7.22
^.^|image:cloud-altemistafwk-documentation/frameworks/logback.png[align="center"] |Logback |1.2.3

^.^|Batch processing
^.^|image:cloud-altemistafwk-documentation/frameworks/spring.png[align="center"] |Spring Batch |4.0.1.RELEASE
...
^.^|Integration
^.^|image:cloud-altemistafwk-documentation/frameworks/spring.png[align="center"] |Spring Integration |5.0.7.RELEASE
...
^.^|image:cloud-altemistafwk-documentation/frameworks/activeMQ.png[align="center"] |ActiveMQ |5.5.1

^.^|Microservices Cloud
^.^|image:cloud-altemistafwk-documentation/frameworks/spring.png[align="center"] |Spring Cloud |Finchley.SR1
...
^.^|image:cloud-altemistafwk-documentation/frameworks/hibernate.png[align="center"] |Hibernate ORM |5.0.11.Final
...
^.^|image:cloud-altemistafwk-documentation/frameworks/mongodb.png[align="center"] |MongoDB |3.2.2
...
^.^|image:cloud-altemistafwk-documentation/frameworks/thymleaf.png[align="center"] |Thymleaf |3.0.9.RELEASE

.3+^.^|Reporting
^.^|image:cloud-altemistafwk-documentation/frameworks/jasperreports.png[align="center"] |JasperReports |6.3.1
...
^.^|Security
^.^|image:cloud-altemistafwk-documentation/frameworks/spring.png[align="center"] |Spring Security |4.1.4.RELEASE

.3+^.^|Spring cloud stream
^.^|image:cloud-altemistafwk-documentation/frameworks/kafka.png[align="center"] |Kafka |2.1.18.RELEASE
...
^.^|image:cloud-altemistafwk-documentation/frameworks/apache-commons.jpg[align="center"] |Apache WSS4J |2.1.8

^.^|Swagger
^.^|image:cloud-altemistafwk-documentation/frameworks/swagger.png[align="center"] |Swagger |2.8.0
