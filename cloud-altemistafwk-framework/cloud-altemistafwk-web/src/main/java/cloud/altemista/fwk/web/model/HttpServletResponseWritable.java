 ...
 * 
 */
package cloud.altemista.fwk.web.model;
...
import cloud.altemista.fwk.web.exception.WebException;
...
public class HttpServletResponseWritable implements ContentWritable {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.common.model.ContentWritable#getOutputStream()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.common.model.ContentWritable#setContentType(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.common.model.ContentWritable#setPath(java.lang.String)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.common.model.ContentWritable#setContentLength(long)
	 */
	@Override
