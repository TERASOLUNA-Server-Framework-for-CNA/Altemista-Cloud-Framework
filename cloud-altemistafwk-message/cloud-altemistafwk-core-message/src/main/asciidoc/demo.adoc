...
include::{basedir}/cloud-altemistafwk-core-message/demo/rabbitMq.adoc[]

== ActiveMQ

include::{basedir}/cloud-altemistafwk-core-message/demo/activeMq.adoc[]


[[demo-resources]]
== Demo resources

include::{basedir}/cloud-altemistafwk-core-message/demo/resources.adoc[]