...
image::cloud-altemistafwk-documentation/microservices/gateway_server_feature.png[align="center"]

Self implementation for a Microservice Gateway Server Infrastructure typology allows to configure any server properties:

image::cloud-altemistafwk-documentation/microservices/gateway_server_additional_properties.png[align="center"]
