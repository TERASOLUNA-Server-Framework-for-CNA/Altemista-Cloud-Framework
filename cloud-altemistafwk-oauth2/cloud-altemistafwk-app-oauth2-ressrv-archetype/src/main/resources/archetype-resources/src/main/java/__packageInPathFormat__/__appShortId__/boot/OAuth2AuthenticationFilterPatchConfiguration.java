package ${package}.${appShortId}.boot;
...
/*
 * If the applications deploys non-Oauth2 authenticaded api (like Authorization Server) uncomment to use this configuration.
 * */
//@Configuration
public class OAuth2AuthenticationFilterPatchConfiguration {
	
	//Change this if needed
	private static final String MAPPING="${resourceServerPattern}";
...
&lt;/bean></pre>
	...
	public FilterRegistrationBean oauth2AuthenticationFilterRegistrationBean(
		...
		bean.setUrlPatterns(Collections.singleton(MAPPING));
		return bean;
	}
}
