...
public class LogMeasuresStorageWrapperImpl extends MeasuresStorageWrapperImpl implements InitializingBean {
	...
	private String loggerName = "cloud.altemista.fwk.PERFORMANCE";
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.common.performance.impl.MeasuresStorageWrapperImpl#put(cloud.altemista.fwk.common.performance.model.MeasuredTask)
	 */
	@Override
