...
package cloud.altemista.fwk.core.performance.jmx.impl;
...
import cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager;
...
public class PerformanceAspectManagerImpl implements PerformanceAspectManager, InitializingBean {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#isEnabled()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#enable()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#disable()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#getNestingLevels()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#setNestingLevels(int)
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#isReflectionEnabled()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#enableReflection()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#disableReflection()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#getMaxLength()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#setMaxLength(int)
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#getMaxDepth()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#setMaxDepth(int)
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#getStopPrintingAfter()
	 */
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.performance.jmx.PerformanceAspectManager#setStopPrintingAfter(int)
	 */
