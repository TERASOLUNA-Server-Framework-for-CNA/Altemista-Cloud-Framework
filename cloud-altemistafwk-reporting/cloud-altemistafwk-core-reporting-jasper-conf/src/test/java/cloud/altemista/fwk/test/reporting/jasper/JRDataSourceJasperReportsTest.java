...
import cloud.altemista.fwk.test.reporting.model.Account;
...
public class JRDataSourceJasperReportsTest extends AbstractJasperReportsTest {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.test.reporting.jasper.AbstractJasperReportTest#additionalReportSetup(cloud.altemista.fwk.common.reporting.model.ReportBean)
	 */
	@Override
