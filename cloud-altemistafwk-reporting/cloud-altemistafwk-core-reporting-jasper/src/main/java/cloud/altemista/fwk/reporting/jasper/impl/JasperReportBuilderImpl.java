...
package cloud.altemista.fwk.reporting.jasper.impl;
...
import cloud.altemista.fwk.core.reporting.impl.AbstractReportBuilderImpl;
...
import cloud.altemista.fwk.reporting.jasper.exporter.JasperExporterPolicy;
...
public class JasperReportBuilderImpl extends AbstractReportBuilderImpl implements InitializingBean {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.reporting.impl.AbstractReportBuilderImpl#afterPropertiesSet()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.reporting.impl.AbstractReportBuilderImpl#newReport()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.reporting.impl.AbstractReportBuilderImpl#internalBuild(cloud.altemista.fwk.common.reporting.model.Report, java.io.InputStream, cloud.altemista.fwk.common.model.ContentWritable)
	 */
	@Override
