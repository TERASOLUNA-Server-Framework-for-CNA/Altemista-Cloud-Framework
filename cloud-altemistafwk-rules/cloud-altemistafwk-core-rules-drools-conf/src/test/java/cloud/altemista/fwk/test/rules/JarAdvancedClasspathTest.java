...
@ContextConfiguration(locations = { "classpath:spring/jarClasspath/test-app-context-rules-jar-advanced.xml" })
public class JarAdvancedClasspathTest extends AdvancedClasspathTest {
