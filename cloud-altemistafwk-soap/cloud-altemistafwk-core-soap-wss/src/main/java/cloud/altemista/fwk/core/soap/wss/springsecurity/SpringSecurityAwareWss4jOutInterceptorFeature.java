package cloud.altemista.fwk.core.soap.wss.springsecurity;
...
import cloud.altemista.fwk.core.soap.wss.Wss4jOutInterceptorFeature;
import cloud.altemista.fwk.core.soap.wss.Wss4jOutInterceptorFeature.UserProvider;
...
public class SpringSecurityAwareWss4jOutInterceptorFeature extends Wss4jOutInterceptorFeature
	...
	public static final UserProvider SECURITY_CONTEXT_USER_PROVIDER = new UserProvider() {
		...
		/* (non-Javadoc)
		 * @see cloud.altemista.fwk.core.soap.wss.Wss4jOutInterceptorFeature.UserProvider#getUser()
		 */
		@Override
