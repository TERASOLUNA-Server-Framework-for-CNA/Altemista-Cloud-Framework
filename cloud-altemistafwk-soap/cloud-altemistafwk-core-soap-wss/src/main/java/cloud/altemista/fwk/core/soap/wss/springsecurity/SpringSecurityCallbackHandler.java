...
import cloud.altemista.fwk.core.soap.wss.AbstractPasswordCallbackHandler;
...
public class SpringSecurityCallbackHandler extends AbstractPasswordCallbackHandler {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.soap.wss.AbstractPasswordCallbackHandler#doHandle(org.apache.wss4j.common.ext.WSPasswordCallback)
	 */
	@Override
