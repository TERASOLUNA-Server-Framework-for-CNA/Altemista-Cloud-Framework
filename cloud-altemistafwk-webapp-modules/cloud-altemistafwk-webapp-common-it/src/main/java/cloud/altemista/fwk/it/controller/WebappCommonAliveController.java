 ...
 */
@RestController
@RequestMapping(value = WebappCommonAliveController.MAPPING, method = RequestMethod.GET)
public class WebappCommonAliveController {

	/** MAPPING String */
	public static final String MAPPING = "/webappcommonalive";
