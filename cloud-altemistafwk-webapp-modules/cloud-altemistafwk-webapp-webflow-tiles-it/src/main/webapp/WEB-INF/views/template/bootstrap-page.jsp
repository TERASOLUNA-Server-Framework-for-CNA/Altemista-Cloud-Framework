...
<html lang="en">
	...
	<body>
		<div class="container">
			...
			<nav class="navbar navbar-default"><tiles:insertAttribute name="nav" /></nav>
			...
			<footer class="panel panel-default"><tiles:insertAttribute name="footer" /></footer>
		</div>
		<%-- Bootstrap core JavaScript
			Placed at the end of the document so the pages load faster --%>
		<script src="<c:url value="/jquery/jquery-1.12.3.min.js" />"></script>
