 ...
 * 
 */
package cloud.altemista.fwk.core.workflow.impl;
...
import cloud.altemista.fwk.core.workflow.AuthenticableWorkflowService;
...
public abstract class AbstractAuthenticableWorkflowService<T> implements AuthenticableWorkflowService<T> {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.workflow.AuthenticableWorkflowService#withCurrentUser()
	 */
	@Override
