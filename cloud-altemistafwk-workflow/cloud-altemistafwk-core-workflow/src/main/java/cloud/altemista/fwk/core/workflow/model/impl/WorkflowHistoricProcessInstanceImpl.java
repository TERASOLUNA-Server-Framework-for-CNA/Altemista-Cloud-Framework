...
public class WorkflowHistoricProcessInstanceImpl implements WorkflowHistoricProcessInstance, Serializable {
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.workflow.model.WorkflowHistoricProcessInstance#getProcesDefinitionId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.workflow.model.WorkflowHistoricProcessInstance#getProcessInstanceId()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.workflow.model.WorkflowHistoricProcessInstance#isActive()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.workflow.model.WorkflowHistoricProcessInstance#getStartTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.workflow.model.WorkflowHistoricProcessInstance#getEndTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.workflow.model.WorkflowHistoricProcessInstance#getAbortReason()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see cloud.altemista.fwk.core.workflow.model.WorkflowHistoricProcessInstance#getProcessInstanceVariables()
	 */
	@Override
